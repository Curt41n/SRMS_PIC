...
//    public ModelAndView roleAdd(@RequestParam(name = "rolename",required = true) String name,
//                                @RequestParam(name = "roledec",required = true) String dec,
//                                @RequestParam(name = "rolerid",required = true) String rid,
//                                HttpServletRequest req){
//        T_Role t_role = new T_Role();
//        t_role.setRname(name);
//        t_role.setRdesc(dec);
//        t_role.setRid(Integer.valueOf(rid));
...
//        T_Role role = roleServiceImpl.selectByname(rname);
...
//            @RequestParam(name = "rolename",required = true) String name,
//            @RequestParam(name = "roledec",required = true) String dec,
...
//        t_role.setRdesc(dec);
//        System.out.println(t_role);
//        roleServiceImpl.updateRole(t_role);
//        ModelAndView mav=new ModelAndView();
//        mav.setViewName("/selectAll");
//
//        return mav;
...
//        List<T_Role> roles = roleServiceImpl.selectAll();
//
...
//            @RequestParam(name = "rolename",required = true) String name,
//            HttpServletRequest request){
//        List<T_Role> roles = roleServiceImpl.selectBysname(name);
//
//        request.getSession().setAttribute("roles",roles);
//
//        ModelAndView mav=new ModelAndView();
...
//
//        String rname = request.getParameter("rname");
//        roleServiceImpl.deleteRole(rname);
//        ModelAndView mav = new ModelAndView();
//        mav.setViewName("/selectAll");
//        return mav;
//
...
//        T_User t_user = roleServiceImpl.selUserInfo(ucode);
//        ModelAndView mav = new ModelAndView();
//        mav.setViewName("userView.html");
//        mav.addObject("user",)
//    }*/
//
//
