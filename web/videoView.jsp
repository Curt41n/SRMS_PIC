...
%@ page import="com.rao.pojo.T_Picture" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%
    T_video video = (T_video) session.getAttribute("videoInfo");
%>
    ...
    <div class="right">
        ...
        <div class="providerView">
            <div class="providerViewLeftbox">
                <p><strong>视频编号：</strong><span>${videoInfo.vid}</span></p>
            <p><strong>文件名称：</strong><span>${videoInfo.vname}</span></p>
            <p><strong>文件大小：</strong><span>10.5MB</span></p>
            <p><strong>文件类型：</strong><span>.mp4</span></p>
            <p><strong>视频分类：</strong><span>${videoInfo.vcate}</span></p>
            <p><strong>审核状态：</strong><span>${videoInfo.vstate}</span></p>
            <p><strong>上传时间：</strong><span>${videoInfo.uploadtime}</span></p>
