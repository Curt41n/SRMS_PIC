    ...
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <div class="providerAdd">
                <form action="${pageContext.request.contextPath}/roleAdd" method="post" >
                    ...
                    <div  class="privilege">
                        <label >用户权限：</label>
                        <input type="radio" name="rolerid" value="1"/>1级
                        <input type="radio" name="rolerid" value="2"/>2级
                        <input type="radio" name="rolerid" value="3"/>3级
                    </div >
